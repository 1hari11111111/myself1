...
# ============================ STICKERS ================================
STICKERID_COUNT = environ.get('STICKERID_COUNT', 'CAACAgUAAxkBAAENqTZnmhnYyi1fO7rXbMUpSO-nNuMZQwACaA4AAi0wUVX9mzhdaNp8XjYE')
STICKERID_ERROR = environ.get('STICKERID_ERROR', 'CAACAgUAAxkBAAENqThnmhofWvnTAuS0awg2GgU0qhyBSAACjxAAAkmsAVb0qb8yZXzsXzYE')
STICKERID_LEECH = environ.get('STICKERID_LEECH', 'CAACAgIAAxkBAAENqTRnmhnMRCy0eBGKlJWRUrdnHaDNkQACtj4AAhWgIEi4sL8wY4CTXzYE')
STICKERID_MIRROR = environ.get('STICKERID_MIRROR', 'CAACAgEAAxkBAAENqTpnmhpOZ9v2Fa1Fgt02ql00O4o1nwACnQMAAlGf0Uf6Fka8Voo_vzYE')
STICKER_DELETE_DURATION = int(environ.get('STICKER_DELETE_DURATION', 120))
# ======================================================================


# ============================ IMAGES ==================================
images = 'https://graph.org/file/123cee8f426c738a75229-675a222b5d07c21c0a.jpg https://graph.org/file/8fa55ae1270ed59122b4d-1b0ef8b18ec529b8ba.jpg \
          https://graph.org/file/446f24d25062f220a18c1-3f13f08f57416f44ab.jpg https://graph.org/file/dc80aa89864bb74a4400a-7f539099db701529a8.jpg \
          https://graph.org/file/4202c13949bf95d5c0c6d-f5b329cd4bdb600c0b.jpg https://graph.org/file/9f4c259e08ae2e59d867c-41deded867f123bb25.jpg'
ENABLE_IMAGE_MODE = environ.get('ENABLE_IMAGE_MODE', 'True').lower() == 'true'
IMAGE_ARIA = environ.get('IMAGE_ARIA', 'https://graph.org/file/9f4c259e08ae2e59d867c-41deded867f123bb25.jpg')
IMAGE_AUTH = environ.get('IMAGE_AUTH', 'https://graph.org/file/20268e03f3ab368c8f06a-e35a12e6725bffaa33.jpg')
IMAGE_BOLD = environ.get('IMAGE_BOLD', 'https://graph.org/file/9ba50d05618206c8ac1b5-861b8fa69c62dac593.jpg')
IMAGE_BYE = environ.get('IMAGE_BYE', 'https://graph.org/file/9ba50d05618206c8ac1b5-861b8fa69c62dac593.jpg')
IMAGE_CANCEL = environ.get('IMAGE_CANCEL', 'https://graph.org/file/b43e73142b882365c1378-da5f1060a5b81af386.jpg')
IMAGE_CAPTION = environ.get('IMAGE_CAPTION', 'https://graph.org/file/9a79b3044ce2997922778-cc62aaa1874ce23f00.jpg')
IMAGE_COMMONS_CHECK = environ.get('IMAGE_COMMONS_CHECK', 'https://graph.org/file/9a79b3044ce2997922778-cc62aaa1874ce23f00.jpg')
IMAGE_COMPLETE = environ.get('IMAGE_COMPLETE', images)
IMAGE_CONEDIT = environ.get('IMAGE_CONEDIT', 'https://graph.org/file/a208bbb5637168b221837-8a0c04dd82612ab677.jpg')
IMAGE_CONPRIVATE = environ.get('IMAGE_CONPRIVATE', 'https://graph.org/file/a208bbb5637168b221837-8a0c04dd82612ab677.jpg')
IMAGE_CONSET = environ.get('IMAGE_CONSET', 'https://graph.org/file/a208bbb5637168b221837-8a0c04dd82612ab677.jpg')
IMAGE_CONVIEW = environ.get('IMAGE_CONVIEW', 'https://graph.org/file/c93a3fe5e73a0a1507f55-f9293602a119da9f32.jpg')
IMAGE_DUMP = environ.get('IMAGE_DUMP', 'https://graph.org/file/c93a3fe5e73a0a1507f55-f9293602a119da9f32.jpg')
IMAGE_EXTENSION = environ.get('IMAGE_EXTENSION', 'https://graph.org/file/c93a3fe5e73a0a1507f55-f9293602a119da9f32.jpg')
IMAGE_GD = environ.get('IMAGE_GD', 'https://graph.org/file/cffb256494d0f0e7e97b3-735430325713f0f8ff.jpg')
IMAGE_HELP = environ.get('IMAGE_HELP', 'https://graph.org/file/cffb256494d0f0e7e97b3-735430325713f0f8ff.jpg')
IMAGE_HTML = environ.get('IMAGE_HTML', 'https://graph.org/file/cffb256494d0f0e7e97b3-735430325713f0f8ff.jpg')
IMAGE_IMDB = environ.get('IMAGE_IMDB', 'https://graph.org/file/2d393659ec4f21962af24-def1ef3393ad7c3c25.jpg')
IMAGE_INFO = environ.get('IMAGE_INFO', 'https://graph.org/file/2d393659ec4f21962af24-def1ef3393ad7c3c25.jpg')
IMAGE_ITALIC = environ.get('IMAGE_ITALIC', 'https://graph.org/file/2d393659ec4f21962af24-def1ef3393ad7c3c25.jpg')
IMAGE_JD = environ.get('IMAGE_JD', 'https://graph.org/file/f635e2737c6cab5d429f1-5a211c55fd417fc200.jpg')
IMAGE_LOGS = environ.get('IMAGE_LOGS','https://graph.org/file/f635e2737c6cab5d429f1-5a211c55fd417fc200.jpg')
IMAGE_MDL = environ.get('IMAGE_MDL', 'https://graph.org/file/20268e03f3ab368c8f06a-e35a12e6725bffaa33.jpg')
IMAGE_MEDINFO = environ.get('IMAGE_MEDINFO', 'https://graph.org/file/20268e03f3ab368c8f06a-e35a12e6725bffaa33.jpg')
IMAGE_METADATA = environ.get('IMAGE_METADATA', 'https://graph.org/file/4202c13949bf95d5c0c6d-f5b329cd4bdb600c0b.jpg')
IMAGE_MONO = environ.get('IMAGE_MONO', 'https://graph.org/file/4202c13949bf95d5c0c6d-f5b329cd4bdb600c0b.jpg')
IMAGE_NORMAL = environ.get('IMAGE_NORMAL', 'https://graph.org/file/4202c13949bf95d5c0c6d-f5b329cd4bdb600c0b.jpg')
IMAGE_OWNER = environ.get('IMAGE_OWNER', 'https://graph.org/file/4af2cc475920dc493a429-5f8ee4bac7c12d5fbc.jpg')
IMAGE_PAUSE = environ.get('IMAGE_PAUSE', 'https://graph.org/file/4af2cc475920dc493a429-5f8ee4bac7c12d5fbc.jpg')
IMAGE_PRENAME = environ.get('IMAGE_PRENAME', 'https://graph.org/file/dc80aa89864bb74a4400a-7f539099db701529a8.jpg')
IMAGE_QBIT = environ.get('IMAGE_QBIT', 'https://graph.org/file/dc80aa89864bb74a4400a-7f539099db701529a8.jpg')
IMAGE_RCLONE = environ.get('IMAGE_RCLONE', 'https://graph.org/file/dc80aa89864bb74a4400a-7f539099db701529a8.jpg')
IMAGE_REMNAME = environ.get('IMAGE_REMNAME', 'https://graph.org/file/dc80aa89864bb74a4400a-7f539099db701529a8.jpg')
IMAGE_RSS = environ.get('IMAGE_RSS', 'https://graph.org/file/dc80aa89864bb74a4400a-7f539099db701529a8.jpg')
IMAGE_SEARCH = environ.get('IMAGE_SEARCH', 'https://graph.org/file/dc80aa89864bb74a4400a-7f539099db701529a8.jpg')
IMAGE_STATS = environ.get('IMAGE_STATS', 'https://graph.org/file/8fa55ae1270ed59122b4d-1b0ef8b18ec529b8ba.jpg')
IMAGE_STATUS = environ.get('IMAGE_STATUS', 'https://graph.org/file/8fa55ae1270ed59122b4d-1b0ef8b18ec529b8ba.jpg')
IMAGE_SUFNAME = environ.get('IMAGE_SUFNAME', 'https://graph.org/file/eefc152a9994e00979f69-2e5ba52a286c190067.jpg')
IMAGE_TMDB = environ.get('IMAGE_TMDB', 'https://graph.org/file/eefc152a9994e00979f69-2e5ba52a286c190067.jpg')
IMAGE_TXT = environ.get('IMAGE_TXT', 'https://graph.org/file/eefc152a9994e00979f69-2e5ba52a286c190067.jpg')
IMAGE_UNAUTH = environ.get('IMAGE_UNAUTH', 'https://graph.org/file/4202c13949bf95d5c0c6d-f5b329cd4bdb600c0b.jpg')
IMAGE_UNKNOW = environ.get('IMAGE_UNKNOW', 'https://graph.org/file/4202c13949bf95d5c0c6d-f5b329cd4bdb600c0b.jpg')
IMAGE_USER = environ.get('IMAGE_USER', 'https://graph.org/file/4202c13949bf95d5c0c6d-f5b329cd4bdb600c0b.jpg')
IMAGE_USETIINGS = environ.get('IMAGE_USETIINGS', 'https://graph.org/file/874d6321b2c176a695713-892bc9f6ad55439264.jpg')
IMAGE_VIDTOOLS = environ.get('IMAGE_VIDTOOLS', 'https://graph.org/file/446f24d25062f220a18c1-3f13f08f57416f44ab.jpg')
IMAGE_WEL = environ.get('IMAGE_WEL', 'https://graph.org/file/8fa55ae1270ed59122b4d-1b0ef8b18ec529b8ba.jpg')
IMAGE_WIBU = environ.get('IMAGE_WIBU', 'https://graph.org/file/8fa55ae1270ed59122b4d-1b0ef8b18ec529b8ba.jpg')
IMAGE_YT = environ.get('IMAGE_YT', 'https://graph.org/file/72cfb10b618df4c8ce138-76a2e5ab1a71acc936.jpg')
IMAGE_ZIP = environ.get('IMAGE_ZIP', 'https://graph.org/file/72cfb10b618df4c8ce138-76a2e5ab1a71acc936.jpg')
# ======================================================================
